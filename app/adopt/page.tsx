    ...
    <main>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {adoptionSteps.map((step, index) => (
              ...
              >
                ...
                <div className="p-8">
                  <div className="w-14 h-14 rounded-2xl bg-sanctuary-primary/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
      ...
      <div className="container mx-auto px-4">
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-bold text-sanctuary-text mb-6">
            Happy Endings
          </h2>
          <p className="text-lg text-sanctuary-text/80">
